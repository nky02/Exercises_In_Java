...
/*This program asks for an acronym and display the phrase they stand for
...
public class InternetAcronyms {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            // Check if the user wants to stop giving acronyms
            ...
            // Process each input from the input line
            ...
            while (scanner.hasNext()) {
                ...
                // Add the meaning of the acronym to the output with a space
